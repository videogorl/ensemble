...
- **Apple Watch App** — Standalone watchOS experience with iCloud Keychain/Plex Link setup, indexed library browsing, cross-server playlist merging, artwork-rich album/playlist details, watch-local streaming playback, and phone remote control through WatchConnectivity
