...
- **Apple Watch App** — Standalone watchOS experience with iCloud Keychain/Plex Link setup, indexed library browsing, cross-server playlist merging, artwork-rich details and Now Playing, continuous album/playlist queues, crown volume, sleep-safe watch-local streaming, and phone remote control through WatchConnectivity
