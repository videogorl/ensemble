...
- **Apple Watch App** — Standalone watchOS experience with iCloud Keychain/Plex Link setup, indexed library browsing, cross-server playlist merging, artwork-rich details and Now Playing, crown volume, sleep-safe watch-local streaming, and phone remote control through WatchConnectivity
