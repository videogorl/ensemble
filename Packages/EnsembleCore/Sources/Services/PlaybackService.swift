...
public final class PlaybackService: NSObject, PlaybackServiceProtocol {
    ...
    // Track auto-generated track IDs to prevent duplicates in queue
    ...
    public func play(tracks: [Track], startingAt index: Int) async {
        ...
        // Reset auto-generated tracking when starting new manual playback
    ...
    public func shufflePlay(tracks: [Track]) async {
        ...
        // Reset auto-generated tracking when starting new shuffle playback
        autoGeneratedTrackIds.removeAll()
    ...
    public func refreshAutoplayQueue() async {
        ...
        if var tracks = recommendations {
            ...
            // Filter out tracks already in queue or already auto-generated
            let existingQueueIds = Set(queue.map { $0.track.id })
            let uniqueNewTracks = tracks.filter { track in
                !existingQueueIds.contains(track.id) && !autoGeneratedTrackIds.contains(track.id)
            }
            ...
            if uniqueNewTracks.isEmpty {
                ...
                // Add only unique recommended tracks directly to the queue
                print("\n🔄 Adding \(uniqueNewTracks.count) new auto-generated tracks to queue...")
