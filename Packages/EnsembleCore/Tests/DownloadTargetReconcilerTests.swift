...
final class DownloadTargetReconcilerTests: XCTestCase {
    private final class LibraryRepositoryMock: LibraryRepositoryProtocol, @unchecked Sendable {
        ...
        func upsertArtist(ratingKey: String, key: String, name: String, summary: String?, thumbPath: String?, artPath: String?, dateAdded: Date?, dateModified: Date?, sourceCompositeKey: String?) async throws -> CDArtist { fatalError() }
