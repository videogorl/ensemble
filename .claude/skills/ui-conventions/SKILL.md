...
- **iPad/macOS:** `ProfileToolbarButton` placed in sidebar toolbar, replacing the previous gear icon. On macOS, Downloads precedes Profile, which uses the native profile glyph so the menu remains visible instead of collapsing into overflow.
