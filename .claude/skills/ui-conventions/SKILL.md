...
- Watch Albums browse uses the native vertical-page `TabView` with the system blur transition for one artwork card per album. Keep the system page indicator, Digital Crown scrolling, album navigation, and scoped More actions; do not replace them with custom drag gestures, scroll tracking, or hand-built 3D transforms.
