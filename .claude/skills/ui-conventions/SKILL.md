...
- On iOS/iPadOS, `RootView` owns software-keyboard visibility for root chrome. The mini player and its reserved clearance should be hidden while the software keyboard is visible; leaf text-entry screens should not move or offset the mini player locally.
