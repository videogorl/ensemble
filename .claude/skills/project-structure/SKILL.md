...
- Root scene layering, chrome geometry registration, mini-player overlay helpers, and the iPad root mini-player window host live in `Packages/EnsembleUI/Sources/Screens/Root/`.
