...
- When source restoration newly enables a server, schedule a follow-up health pass after any in-flight pass completes. An earlier pass over a partial source configuration must not leave the restored server indefinitely unknown.
