...
- Watch-local playback snapshots the selected detail's tracks for Previous/Next. Previous restarts after three seconds or moves to the prior track near the start; Next does not wrap past the final track.
