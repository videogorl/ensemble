...
- Active incremental streams must not fake seek success. Until a stream can be repositioned by range/session restart or a completed cache file, seek attempts should leave the real playhead and UI clock unchanged.
