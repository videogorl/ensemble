...
- Builds without the configured iCloud container entitlement must disable CloudKit profile transport and report it as unavailable instead of crashing during dependency bootstrap. Properly entitled production and development builds must retain normal CloudKit behavior.
