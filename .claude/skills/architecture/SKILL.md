...
- External device sync is additive and mapped-only. Persist source-scoped device maps, never fuzzy-match iPod content to Plex objects, and discard unmapped imports rather than creating orphan Plex data.
