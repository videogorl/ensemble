...
# Architecture Inventory Archive

This is the pre-cleanup long-form architecture skill archived on May 13, 2026. The canonical hot-path skill is `.claude/skills/architecture/SKILL.md`; use this file only when a historical full subsystem inventory is useful.
